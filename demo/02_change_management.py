...
# MAGIC FROM list_volume_files('/Volumes/lr_serverless_aws_us_catalog/insurance_poc/raw_policies/') f
# MAGIC LEFT JOIN lr_serverless_aws_us_catalog.insurance_poc.processing_log p
