...
# MAGIC |---|---------|--------------|----------|
# MAGIC | 1 | [End-to-End Walkthrough]($./01_walkthrough) | Full pipeline: PDF → parse → graph → vector → Genie → supervisor → app | 15 min |
...
# MAGIC | 4 | [Performance & Architecture]($./04_performance_architecture) | Latency analysis, production optimisations, graph DB comparison | 10 min |
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC ## Live Assets
...
# MAGIC │       ▼                            ▼                       ▼       │
# MAGIC │  ┌──────────────┐        ┌─────────────────────────────────────┐  │
# MAGIC │  │  Knowledge   │        │        Genie Room (AI/BI)           │  │
...
# MAGIC │  │  Supervisor (Claude+KA) │ KA Direct │ Genie Direct         │  │
# MAGIC │  └─────────────────────────────────────────────────────────────┘  │
# MAGIC │                                                                     │
# MAGIC │  ┌─────────────────────────────────────────────────────────────┐   │
...
# MAGIC | Foundation Model API | Claude Sonnet 4.6 for supervisor synthesis |
# MAGIC | Knowledge Assistants | Vector search over raw documents |
# MAGIC | AI/BI Genie | Natural language to SQL over graph tables |
# MAGIC | Mosaic AI Agent Framework | Supervisor agent deployment |
